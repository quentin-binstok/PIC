 ...
 *        x and y are read as the initial position and overwritten with the new
 * one.
 */
...
/**
 * @brief Linear interpolation kernel used when transferring particle quantities
 * to the grid.
 */
...
/**
 * @brief Recomputes per-cell density, removes out-of-bounds and solid
 * particles.
 */
