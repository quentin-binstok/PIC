...
This repository contains the code for the class _Multiphysics Integrated Computational Project_ given at the University of Liège. The documentation is available at [Table of contents](docs/toc.md).
